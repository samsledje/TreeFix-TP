...
# treefix libraries
from treefix_tp.models import StatModel

# treefix_raxml library
import treefix_tp.pyRAxML as raxml
...
# compbio libraries
from treefix_tp.compbio import phylip
...
class RAxMLModel(StatModel):
    ...
    def optimize_model(self, gtree, aln):
        ...
        self._raxml.optimize_model(
            treefile, seqfile, "-m %s -e %s -n test" % (self.model, self.eps)
        )
